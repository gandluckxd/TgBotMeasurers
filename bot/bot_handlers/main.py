...
from bot_handlers.handlers import (
    registration_router,
    invite_links_router,
    admin_router,
    measurer_router,
...
from bot_handlers.middlewares import RoleCheckMiddleware, LoggingMiddleware
...
async def main():
    ...
    from bot_handlers.utils.logger_config import setup_logging
    setup_logging()
